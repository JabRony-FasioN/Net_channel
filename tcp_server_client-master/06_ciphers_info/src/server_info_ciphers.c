//TLS-Server.c при подключении полный список доступных шифров
#include <errno.h>
#include <unistd.h>
#include <malloc.h>
#include <string.h>
...
SSL_CTX* InitServerCTX(void)
{
	...
	char *cipher_list = getenv("TLS_CIPHER_LIST");
    if (cipher_list == NULL)
        cipher_list = "ALL:eNULL";
...
void Servlet(SSL* ssl) /* Serve the connection -- threadable */
{
	...
	strcat(output, enter);
	strcat(output, "<html><body><h1>TLS server msg!</h1></body></html>");
