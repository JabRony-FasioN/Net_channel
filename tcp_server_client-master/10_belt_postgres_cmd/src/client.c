...
int main(int argc, char **argv)
{
    ...
    if (argc < 2) {
        printf("Please provide a psql command as an argument.\n");
...
//    PrintAvailableCiphers(ctx);  //Output the Available Ciphers. work!!!
    ...
    {
        // use command line argument as the psql command
        char *msg = argv[1]; // getting psql command from command line argument
